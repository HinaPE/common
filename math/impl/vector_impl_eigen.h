...
template<typename T> auto Vector3<T>::norm() const -> T 						{ return length(); }
template<typename T> auto Vector3<T>::length_squared() const -> T 				{ return _v.squaredNorm(); }
template<typename T> auto Vector3<T>::squared_norm() const -> T 				{ return length_squared(); }
...
template<typename T> auto Vector2<T>::norm() const -> T 						{ return length(); }
template<typename T> auto Vector2<T>::length_squared() const -> T 				{ return _v.squaredNorm(); }
template<typename T> auto Vector2<T>::squared_norm() const -> T 				{ return length_squared(); }
...
template<typename T> auto Vector4<T>::norm() const -> T 						{ return length(); }
template<typename T> auto Vector4<T>::length_squared() const -> T 				{ return _v.squaredNorm(); }
template<typename T> auto Vector4<T>::squared_norm() const -> T 				{return length_squared(); }
