...
//	auto bbox() const -> mBBox3 { return mBBox3(_opt.origin, mVector3{_opt.origin.x() + _opt.grid_spacing.x() * static_cast<real>(_opt.resolution.x), _opt.origin.y() + _opt.grid_spacing.y() * static_cast<real>(_opt.resolution.y), _opt.origin.z() + _opt.grid_spacing.z() * static_cast<real>(_opt.resolution.z)}); }
//
//public:
//	struct Opt
//	{
...
//	virtual auto data_size() const -> mSize3 = 0; /// not necessarily equal to _opt.resolution
//	virtual auto data_origin() const -> mVector3 = 0; /// not necessarily equal to _opt.origin
...
//	void fill(const std::function<real(const mVector3 &)> &func, Util::ExecutionPolicy policy = Util::ExecutionPolicy::Parallel) { Util::parallelFor((size_t) 0, _data.size().x, (size_t) 0, _data.size().y, (size_t) 0, _data.size().z, [&](size_t i, size_t j, size_t k) { _data(i, j, k) = func(data_position()(i, j, k)); }, policy); }
//
...
//	auto operator()(size_t i, size_t j, size_t k) -> real & { return _data(i, j, k); }
//	auto operator()(size_t i, size_t j, size_t k) const -> const real & { return _data(i, j, k); }
//
//private:
...
//{
//public:
//	auto data_size() const -> mSize3 final { return _opt.resolution; }
//	auto data_origin() const -> mVector3 final { return _opt.origin + Constant::Half * _opt.grid_spacing; }
//};
//class VertexCenteredScalarGrid3 : public ScalarGrid3
//{
//public:
//	auto data_size() const -> mSize3 final { return _opt.resolution + mSize3(1, 1, 1); }
//	auto data_origin() const -> mVector3 final { return _opt.origin; }
//};
//// ============================== ScalarGrid3 ==============================
//
//
