...
public:
	...
	static auto build(const std::vector<mVector3> &vertices, const std::vector<mVector3> &indices, const Math::Size3& resolution, real spacing = 0.1, int exact_band = 1) -> Geom::DataGrid3<real>;
};
} // namespace HinaPE::Experimental
