...
auto HinaPE::Experimental::SDF::build(const std::vector<mVector3> &vertices, const std::vector<unsigned int> &indices, const Math::Size3 &resolution, real spacing, const int exact_band) -> Geom::DataGrid3 <real>
{
	// init sdf
